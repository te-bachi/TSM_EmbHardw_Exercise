...
#### CAMERA
    set_location_assignment PIN_T4  -to CAM_I2C_SCL
    set_location_assignment PIN_P4  -to CAM_I2C_SDA
    set_location_assignment PIN_V1  -to CAM_I2C_MIRQ
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to CAM_I2C_SCL
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to CAM_I2C_SDA
    ...
    set_location_assignment PIN_W1  -to CAM_HREF
