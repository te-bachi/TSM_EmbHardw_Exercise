...
set_location_assignment PIN_B11  -to DIP_SWITCHES[0]
set_location_assignment PIN_A11  -to DIP_SWITCHES[1]
set_location_assignment PIN_B12  -to DIP_SWITCHES[2]
set_location_assignment PIN_A12  -to DIP_SWITCHES[3]
set_location_assignment PIN_AA12 -to DIP_SWITCHES[4]
set_location_assignment PIN_AB12 -to DIP_SWITCHES[5]
set_location_assignment PIN_AA11 -to DIP_SWITCHES[6]
set_location_assignment PIN_AB11 -to DIP_SWITCHES[7]

set_location_assignment PIN_H11  -to BUTTONS[0]
set_location_assignment PIN_H10  -to BUTTONS[1]
set_location_assignment PIN_G11  -to BUTTONS[2]
set_location_assignment PIN_G10  -to BUTTONS[3]
set_location_assignment PIN_G9   -to BUTTONS[4]
set_location_assignment PIN_G8   -to BUTTONS[5]
set_location_assignment PIN_G7   -to BUTTONS[6]
set_location_assignment PIN_F7   -to BUTTONS[7]
set_location_assignment PIN_E10  -to BUTTONS[8]
set_location_assignment PIN_E9   -to BUTTONS[9]
set_location_assignment PIN_D7   -to BUTTONS[10]
...
set_location_assignment PIN_A18  -to LCD_RESET_n
set_location_assignment PIN_G14  -to LCD_CS_n
set_location_assignment PIN_H14  -to LCD_D_C_n
set_location_assignment PIN_G15  -to LCD_WR_n
set_location_assignment PIN_H15  -to LCD_RD_n
